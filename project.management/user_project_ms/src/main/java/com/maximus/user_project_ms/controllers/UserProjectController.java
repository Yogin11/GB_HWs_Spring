package com.maximus.user_project_ms.controllers;

//import com.maximus.user_project_ms.models.Project;
//import com.maximus.user_project_ms.models.User;
import com.maximus.user_project_ms.services.UserProjectService;
...
public class UserProjectController {
    ...
    public ResponseEntity<List<Object>> getUsersByProjectId(@PathVariable("projectId") Long projectId) {
    ...
    public ResponseEntity<List<Object>> getProjectsByUserId(@PathVariable Long userId) {
